...
const slides = [
  {
    image: require("../../Image/psCart/1.jpg"),
    quote:
      
"Elevate your style game with PsCart – Where Fashion meets Confidence!",
    saleText:
      "Get in the game with up to 50% off on a wide range of fashions ",
    productText: "Shop Now",
  },
  {
    image: require("../../Image/psCart/2.jpg"),
    quote:
  ...
  {
    image: require("../../Image/psCart/3.jpg"),
    quote:
  ...
  {
    image: require("../../Image/psCart/4.png"),
    quote:
      "Dress like you're already famous. Shop at PsCart and let your style do the talking",
    saleText: "Discover the art of timeless elegance. PsCart - Your destination for sophistication",
